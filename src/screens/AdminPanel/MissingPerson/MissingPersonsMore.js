...
export default class MissingPersonsMore extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            missingp_name:this.props.navigation.state.params.MisiingPerson.Person_Name,
            missingp_type:this.props.navigation.state.params.MisiingPerson.Person_Type,
            missingp_district:this.props.navigation.state.params.MisiingPerson.Person_District,
            missingp_height:this.props.navigation.state.params.MisiingPerson.Person_Height,
            ...
            missingp_lastseen:this.props.navigation.state.params.MisiingPerson.Last_Seen_Location,
            reporter_name:this.props.navigation.state.params.MisiingPerson.Reporter_Name,
            reporter_email:this.props.navigation.state.params.MisiingPerson.gmail,
            reporter_mobno:this.props.navigation.state.params.MisiingPerson.Reporter_Mobile_Number,
        }
    }
    ...
    render() {
        return (
            ...
            <HeaderBackBtn title='Missing Persons' onPress={ () => this.backButtonOnPress()}/>

            <Text style={styles.title}>Missing Person In {this.state.missingp_lastseen}</Text>


            <View style={styles.missingPersons}>
            <Text style={styles.misssingPersonsText}>Name : </Text>
            <Text style={styles.misssingPersonsText}>{this.state.missingp_name}</Text>
            </View>

            <View style={styles.missingPersons}>
            <Text style={styles.misssingPersonsText}>Type : </Text>
            <Text style={styles.misssingPersonsText}>{this.state.missingp_type}</Text>
            </View>

            <View style={styles.missingPersons}>
            <Text style={styles.misssingPersonsText}>District : </Text>
            <Text style={styles.misssingPersonsText}>{this.state.missingp_district}</Text>
            </View>

            <View style={styles.missingPersons}>
            <Text style={styles.misssingPersonsText}>Height : </Text>
            <Text style={styles.misssingPersonsText}>{this.state.missingp_height}</Text>
            </View>

            <View style={styles.missingPersons}>
            <Text style={styles.misssingPersonsText}>Age : </Text>
            <Text style={styles.misssingPersonsText}>{this.state.missingp_age}</Text>
            </View>

            <View style={styles.missingPersons}>
            <Text style={styles.misssingPersonsText}>Gender : </Text>
            <Text style={styles.misssingPersonsText}>{this.state.missingp_gender}</Text>
            </View>

            <View style={styles.missingPersons}>
            <Text style={styles.misssingPersonsText}>Last Seen Location : </Text>
            <Text style={styles.misssingPersonsText}>{this.state.missingp_lastseen}</Text>
            </View>
...
const styles = StyleSheet.create({
    ...
    headerView:{
        ...
        height:Metrics.DEVICE_HEIGHT/1.06
    },
    title:{
